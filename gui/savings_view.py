...
def view_savings(root, content_box, logic):
    ...
    def handle_submit():
        try:
            ...
            tk.messagebox.showwarning("Error", "Invalid Input.")
    target_button = tk.Button(left_frame, text="Add Target", bg=COLOR_SIDEBAR, font=("Calibri", 14, "bold"), fg="white", bd=0, padx=15, pady=8, command=handle_submit)
    ...
    def create_target_card(parent, row, col, target_id, name, cost_str, saved_str, needed_str, progress_val, date):
        ...
        # saved button
        saved_button = tk.Button(top_row, text="Add Funds", font=("Calibri", 10), fg="green", bg=COLOR_CARD_BG, bd=0, cursor="hand2")
