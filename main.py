...
# sidebar
sidebar = tk.Frame(root, bg=COLOR_SIDEBAR, highlightbackground='black', highlightthickness=1, bd=0, width=200)
sidebar.pack(side="left", fill="y")
sidebar.pack_propagate(False) # Makes the sidebar fixed dimension

# main area
main_area = tk.Frame(root, bg=COLOR_MAIN_BG, highlightbackground='black', highlightthickness=1, bd=0)
main_area.pack(side="left", fill="both", expand=True)

app_name = tk.Label(sidebar, text="TRAKKI", font=("Roboto", 30, "bold"), bg=COLOR_SIDEBAR, fg="white")
...
for item_name, builder_func in nav_items:
    ...
    btn = tk.Button(sidebar, text=item_name, font="Calibri 16", bg=COLOR_SIDEBAR, fg="white", anchor="w", bd=0, padx=20, pady=10, cursor="hand2", command=lambda name=item_name: show_page(name))
...
# my alias
dev_name = tk.Label(sidebar, text="aldrsze.", font=("Roboto", 12), bg=COLOR_SIDEBAR, fg="white")
